...
class MultiviewHandReconwithMLPHand(nn.Module, ModuleAbstract):

    def __init__(self, cfg):
        super(MultiviewHandReconwithMLPHand, self).__init__()
        ...
        self.MLPhand = MLPHand_v2(n_view=self.n_view,view_channel=self.feat_size[-2])
    ...
    def _forward_impl(self, batch, **kwargs):
        ...
        uv_feat=self.dropouts[3](uv_feat)
